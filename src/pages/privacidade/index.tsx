...
function privacidade() {
    return (
        ...
        <ContainerPrivacidade>
            ...
            <Privacidade>
                <h1>Política de privacidade para Fortnite</h1>
                <br />
                <p>Esta é a Política de Privacidade para Fortnite, acessível em https://Fortnite.com.br</p>
                <br />
                ...
                <p> Para obter mais informações gerais sobre cookies, leia <Link href="https://www.privacypolicyonline.com/what-are-cookies/"> "O que são cookies" .</Link> </p>
                ...
                <br />
                <ul>
                <li> Email: Fortnite@gmail.com.br </li>
                </ul>
            </Privacidade>
        </ContainerPrivacidade>
        <Footer />
